    ...
    <div className=' grow max-w-[85rem] w-full justify-items-center  mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  mt-6 gap-6'>
      {TEAM.map((member, index) => (
        ...
        >
          ...
          <div className='translate-y-full bg-white absolute top-0 left-0 right-0 bottom-0 transition-transform group-hover:translate-y-0 z-[1] text-[0.78rem] md:text-sm p-4 tracking-wide border-t-4 border-t-indigo-400 rounded-xl duration-300'>
