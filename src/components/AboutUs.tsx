  ...
  return (
    <div className='grow grid gap-6 max-w-6xl mx-auto w-full px-4'>
      <div className='grid grid-cols-12 gap-6'>
        <div className='w-[20rem] mx-auto md:w-full col-span-12 md:col-span-6 relative group shadow-md shadow-indigo-200  rounded-xl  overflow-hidden  h-fit p-6'>
          <Image
          ...
          >
            <p className='text-base lg:text-lg font-light italic leading-[1.5rem] md:leading-[1.8rem]'>
        ...
        <div className='w-[20rem] mx-auto md:w-full col-span-12 md:col-span-6 relative group shadow-md shadow-sky-200  rounded-xl  overflow-hidden h-fit p-6'>
          <Image
          ...
          >
            <p className='text-base lg:text-lg font-light italic leading-[1.5rem] md:leading-[2rem]'>
      ...
      <div className='grid grid-cols-12 gap-6'>
        <div className='w-[20rem] mx-auto md:w-full col-span-12 md:col-span-6 relative group shadow-md shadow-fuchsia-200 rounded-xl  overflow-hidden  h-fit p-6'>
          <Image
        ...
        <div className='w-[20rem] mx-auto md:w-full col-span-12 md:col-span-6 relative group  shadow-md shadow-teal-200  rounded-xl  overflow-hidden h-fit p-6'>
          <Image
